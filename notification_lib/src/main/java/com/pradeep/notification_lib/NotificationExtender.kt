...
internal class NotificationExtender : NotificationCompat.Extender {
    ...
    internal fun setStackable(stackable: Boolean = true): NotificationExtender {
        this.stackable = stackable
        return this
    }

    internal fun setStacked(stacked: Boolean = true): NotificationExtender {
        this.stacked = stacked
        return this
    }

    internal fun setKey(key: CharSequence?): NotificationExtender {
        this.stackKey = key
        return this
    }

    internal fun setSummaryText(text: CharSequence?): NotificationExtender {
